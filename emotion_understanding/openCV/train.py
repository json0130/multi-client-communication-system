...
# ============== MODEL =================
name = 'resnet18'  # Change this to 'resnet18', 'resnet50', 'efficientnet', or 'efficientnetv2' as needed
...
# ============== TRAIN =================
modelName = "resnet18_HQRAF_opencv.pth"
...
def evaluate_on_test_set():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("confusion_matrix_resnet18_new.png")
        plt.show()
    except ImportError:
